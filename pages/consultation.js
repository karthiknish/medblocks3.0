      ...
      <Section>
        ...
        <div className="space-y-10">
          ...
          <div>
            <a
              href="mailto:sidharth@medblocks.org"
              className="rounded-mdhover:bg-green-700 mt-5 bg-green-500 font-semibold text-white py-2 px-4 border"
            >
              <span>Send Email</span>
            </a>
          </div>
          <section className="flex flex-col lg:flex-row items-center lg:justify-center w-full lg:px-10 space-x-3">
            <article className="bg-white w-4/5 lg:w-custom mb-10 lg:px-4 px-6 py-10 text-center text-primary-dark rounded-lg shadow-lg">
              ...
              <ul className="text-sm font-bold">
                <li className="pt-4 pb-4  border-gray-300">
                  An average session lasts for an hour, rounded off to the
                  nearest 30 mins. 1 hour 30 mins will count as 2 sessions,
                  while 1 hour 15 mins count as 1 session.
                </li>
              </ul>
            </article>

            <article
              className="w-4/5 lg:w-custom mb-10 lg:px-4 px-6 py-10 text-center text-white rounded-lg shadow-lg"
              style={{
                backgroundImage:
                  "linear-gradient(90deg, #8EDF54 0%, #49891A 100%)",
              }}
            >
          ...
          <section
            className={`flex flex-col lg:flex-row ${
              openone || opentwo || openthree
                ? "lg:items-start items-center"
                : "items-center"
            } lg:justify-center w-full lg:px-10 space-x-3`}
          >
            <article className="bg-white w-4/5 lg:w-custom mb-10 lg:px-4 px-6 py-10 text-center text-primary-dark rounded-lg shadow-lg">
          ...
          {/* <div>
            <h2 className="text-lg font-semibold text-gray-600">Standard</h2>
            <p className="text-2xl">₹ 3000 / session</p>
            <p>
              An average session lasts for an hour, rounded off to the nearest
              30 mins. 1 hour 30 mins will count as 2 sessions, while 1 hour 15
              mins count as 1 session.
            </p>
          </div>
          <div>
            <h2 className="text-lg font-semibold text-gray-600">Monthly</h2>
            <p className="text-2xl">₹ 20,000 / month</p>
            <p>
              10 sessions / month and priority support. For teams requiring
              long-term clinical modelling and implementation support.
            </p>
          ...
          <div>
            ...
            <p>
              Get up and running with your clinical data using openEHR. All the
              sessions are personalized to your needs and uses your clinical
              data templates as examples.
            </p>
            ...
            <div className=" space-y-4 mt-4">
              ...
              <p>
                ...
                <br />
                Clinical Modelling - Create Archetypes and Templates for your
                implementation.
              </p>
              <p>
          ...
          <div>
            ...
            <p className="text-2xl">₹ 10,000</p>
            <p>
              Understand FHIR, and start profiling resources for your use case.
              Implement your business logic in FHIR, with hand-on examples on
            ...
            <div className=" space-y-4 mt-4">
              ...
              <p>
                <strong>Session 2</strong>
                <br />
                FHIR Profiles and Profiling - Understanding different profiles
                and mapping data to and from FHIR.
              </p>
              <p>
                <strong>Session 3</strong>
                <br />
              ...
              <p>
                <strong>Session 4</strong>
                <br />
                SMART on FHIR and deployment and management on Cloud Platform
                (Google APIs for FHIR, Azure FHIR Platform)
              </p>
            </div>
          </div>
          <div>
            ...
            <p>
              Enable semantic interoperability with using the most prefered
              terminology across the world. Set up your own SNOMED CT server and
              start creating reference sets and extensions for your
              implementation.
            </p>
            <div className=" space-y-4 mt-4">
              <p>
              ...
              <p>
                <strong>Session 2</strong>
                <br />
                Designing interfaces that use SNOMED CT for data entry. Creating
                reference sets and using SNOMED EQL.
              </p>
              <p>
                <strong>Session 3</strong>
                <br />
                Creating SNOMED CT extensions to cover gaps in content, language
                maps.
              </p>
              <p>
                <strong>Session 4</strong>
